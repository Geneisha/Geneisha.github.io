$(function () {
  ...
  function setup() {
    ...
    // "Middle" Platform 
    createPlatform(600, 600, 200, 15)
    // "Right" Platform 
    createPlatform(900, 600, 200, 15)
    // Wall for middle platform.
    createPlatform(700, 550, 15, 55)
    // Wall for right platform.
    createPlatform(1000, 550, 15, 55)
